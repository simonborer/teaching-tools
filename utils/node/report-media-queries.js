...
const reportMediaQueries = function(src) {
    const cssContent = fs.readFileSync(src, 'utf8');
    const parsedcss = postcss.parse(cssContent, { source: src }).nodes;
    detectMobileLast(parsedcss);
};

exports.reportMediaQueries = reportMediaQueries;